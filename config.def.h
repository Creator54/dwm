...
static Key keys[] = {
  ...
  { MODKEY,                          XK_slash,                 spawn,          SHELL("vicinae open") },
  ...
  { MODKEY|ShiftMask,                XK_s,                     spawn,          SHELL("flameshot gui") },
  ...
  { MODKEY,                          XK_l,                     spawn,          SHELL("betterlockscreen -l blur") },
  { MODKEY|Mod1Mask,                 XK_Return,                spawn,          SHELL("$TERM") },
  { MODKEY|ShiftMask,                XK_n,                     spawn,          RUN("nautilus") },
  { MODKEY|ShiftMask,                XK_Return,                spawn,          SHELL("kitty") },
  ...
  { MODKEY,                          XK_q,                     spawn,          SHELL("betterlockscreen -l blur") },
